...
export default function Hero() {
  ...
  useEffect(() => {
    scrollYProgress.onChange(() => {
      setFilter("blur(" + blur.get() + "px)");
    });
  }, [scrollYProgress]);
  return (
    // bg-gradient-to-tr from-[#FF0A54] to-pink-600
    <div  className="h-[100vh-60rem] w-full rounded-md flex md:items-center md:justify-center bg-black/[0.96] antialiased bg-grid-white/[0.02] relative overflow-hidden">
    {/* // <div className=" bg-gradient-to-r from-rose-100 to-teal-100 min-h-screen animate-shiny bg-white"> */}
       <Spotlight
    className="-top-40 left-0 md:left-60 md:-top-20"
    fill="white"
  />
  <div className="100vh" ref={ref}/>
        ...
        <div className="mx-auto max-w-7xl pb-24 pt-10 sm:pb-32 lg:grid lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:py-30">
          <div className="px-6 lg:px-0 lg:pt-4">
            <div className="mx-auto max-w-2xl">
              ...
              initial={{ y: -10, size: 0.8,opacity:0 }}
              // whileInView={{ size: 1,opacity:1 }}
              animate={{ y: 10,opacity:1,size: 1 }}
              transition={{
                type: "smooth",
                duration: 2,
                delay:1.3,
              ...
              >
                ...
                <Link href="#projects" className="relative px-6 py-3 font-bold text-white/[0.92] group">
                <span className="absolute inset-0 w-full h-full transition duration-300 ease-out transform -translate-x-2 -translate-y-2 bg-gradient-to-tr from-[#6740f6] to-pink-600 group-hover:translate-x-0 group-hover:translate-y-0"></span>
