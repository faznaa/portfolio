...
const Circles = () => {
  return (
    <>
      <circle cx="200" cy="200" r="4" fill="limegreen" stroke="none"></circle>
      ...
      <circle cx="920" cy="440" r="4" fill="skyblue" stroke="none"></circle>
...
const Gradients = () => {
  return (
    <defs>
      ...
      <motion.linearGradient id="orangeGradient" gradientUnits="userSpaceOnUse">
...
export default function Hire() {
  ...
  return (
    <div className="bg-black min-h-screen relative">
            ...
            <div className="mx-auto max-w-full">
              <FadeIn>
                <div className="mx-auto max-w-4xl relative flex flex-col justify-center items-center">
                  ...
                  <p className="max-w-2xl mx-auto text-center text-gray-300 text-[20px] sm:text-md font-bold ">
                    Are you prepared to embark on an extraordinary coding
                    journey? Don’t miss your chance to create extraordinary
                    digital experiences like no other. Reach out now and explore
                    new worlds of coding enchantment!
                  </p>
      ...
      <div className="absolute inset-0 hidden sm:flex items-center z-0 opacity-90">
        <svg
      ...
      <div className="absolute inset-0 flex sm:hidden  items-center z-0 opacity-90">
        <svg
          className="w-full h-full"
          viewBox={`0 0 ${width} ${height}`}
          xmlns="http://www.w3.org/2000/svg"
